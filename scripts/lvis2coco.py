...
def parse_args():
    ...
    parser.add_argument('--lvis', help='json file of lvis annotation of coco val set', default='data/lvis/annotations/lvis_v1_val.json')
    parser.add_argument('--coco', help='json file of dt results in coco format', default='data/coco/annotations/instances_val2017.json')
    parser.add_argument('--output', help='output json file of dt results in lvis format', default='data/lvis/annotations/lvis_v1_val_cocofied.json')
